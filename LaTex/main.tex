...
\begin{itemize}
    \item Grafite: I valori ottenuti nelle due sessioni, pari a $1.22 \pm 0.13$ cal/(mol K) e $1.16 \pm 0.10$ cal/(mol K), risultano estremamente coerenti tra loro e ben allienati con i valori teorici attesi per questo intervallo di temperatura.
    \item Piombo: Le misurazioni hanno fornito i valori di $7.14 \pm 0.86$ cal/(mol K) e $7.24 \pm 0.69$ cal/(mol K). Questi risultati si presentano leggermente sovrastimati rispetto al range teorico previsto, che oscilla tra 5.54 e 6.44 cal/(mol K).
\end{itemize}
...
Tuttavia l'accuratezza assoluta delle misurazioni risente intrinsecamente delle condizioni non ideali di isolamento dell'apparato sperimentale, seppur garantendo una notevole precisione e riproducibilità statistica tra tentativi indipendenti.
\end{document}