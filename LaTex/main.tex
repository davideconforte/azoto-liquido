...
\begin{itemize}
    ...
    \item Massa molare della grafite ($M_{mol}$): $12.011\text{ g/mol}$
\end{itemize}

\subsection{Estrapolazione Lineare delle Fasi e Calcolo della Massa Evaporata}
...
\subsection{Determinazione del Calore Specifico Molare}
